...
import AvatarGroup from '../layouts/AvatarGroup'; // Update this path as per your folder structure
  ...
  return (
    ...
    >
      ...
      <div className={`px-4 border-l-[3px] ${status === 'In Progress' ? 'border-cyan-500' : status === 'Completed' ? 'border-indigo-500' : 'border-violet-500'}`}>
        ...
        <p className='text-[13px] text-gray-700/70 font-medium mt-2 leading-[18px]'>
          Task Done:{' '}
      ...
      <div className='flex items-center gap-2 bg-blue-50 px-2.5 py-1.5 rounded-lg mx-4 mt-2'>
        <AvatarGroup avtars={assignedTo || []} />
        {attachmentCount > 0 && (
